...
const JobListing = () => {
    ...
    <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
                ...
                isSearched && (searchFilter.title !== "" || searchFilter.location !== "") && (
                    <>
                        ...
                        <div className='mb-4 text-gray-600'>
                            {searchFilter.title && (
                                <span className='inline-flex items-center gap-2.5 bg-blue-50 border border-blue-200 px-4 py-1.5 rounded m-0.5'>
                                    {searchFilter.title}
                            ...
                            {searchFilter.location && (
                                <span className='inline-flex items-center gap-2.5 bg-red-50 border border-red-200 px-4 py-1.5 rounded m-0.5'>
                                    {searchFilter.location}
        ...
        {/* Job listings */}
        <section className='w-full lg:w-3/4 text-gray max-lg:px-4'>
